...
async function runDailyReport() {
  console.log("\n╔══════════════════════════════════════╗");
  console.log("║      MOOD-AWARE APP — DAY 4          ║");
  console.log("╚══════════════════════════════════════╝\n");
  ...
  const moodLabel = avgMood >= 7 ? "🟢 Good"  :
                    avgMood >= 5 ? "🟡 Okay"  : "🔴 Rough";

  const stepLabel = fitness.steps >= 8000 ? "🟢 Active"  :
                    fitness.steps >= 5000 ? "🟡 Moderate": "🔴 Low";

  const sleepLabel = fitness.sleepHours >= 7 ? "🟢 Rested"  :
                     fitness.sleepHours >= 6 ? "🟡 Okay"    : "🔴 Tired";
