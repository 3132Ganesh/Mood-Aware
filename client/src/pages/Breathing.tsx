  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <main className="flex-1 lg:pl-64 flex flex-col min-w-0 pb-28 lg:pb-12">
        ...
        {/* ========================================================================= */}
        <div className="hidden lg:block p-8 max-w-5xl w-full mx-auto space-y-8">
          ...
          <header className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-display font-bold bg-gradient-to-r from-blue-600 via-primary to-accent bg-clip-text text-transparent mt-1">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              <Card className="border-none shadow-md bg-card/85 backdrop-blur-md p-5 rounded-3xl border border-border/40 space-y-2">
                <div className="w-10 h-10 rounded-2xl bg-purple-500/10 text-purple-600 flex items-center justify-center">
                  <Brain className="w-5 h-5" />
                </div>
                <h4 className="text-sm font-bold text-foreground">Vagus Nerve Activation</h4>
              ...
              <Card className="border-none shadow-md bg-card/85 backdrop-blur-md p-5 rounded-3xl border border-border/40 space-y-2">
                ...
                <h4 className="text-sm font-bold text-foreground">Sleep Induction</h4>
                <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              <Card className="border-none shadow-md bg-card/85 backdrop-blur-md p-5 rounded-3xl border border-border/40 space-y-2">
                ...
                <h4 className="text-sm font-bold text-foreground">Anti-Stress Shield</h4>
                <p className="text-xs text-muted-foreground leading-relaxed">
